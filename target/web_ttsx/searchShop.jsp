...
<div class="breadcrumb">
    ...
    <span>&gt;</span>
    <span>搜索"${requestScope.search}"</span>
</div>
...
<div class="main_wrap clearfix">
    ...
    <div class="r_wrap fr clearfix">
        ...
        <div class="pagenation">
                <a href="searchGoodByFenYe?pageNum=1&search=${requestScope.search}">首页</a>
                <a href="searchGoodByFenYe?pageNum=${requestScope.page.previous}&search=${requestScope.search}">上一页</a>
                <a href="searchGoodByFenYe?pageNum=${requestScope.page.next}&search=${requestScope.search}">下一页</a>
                <a href="searchGoodByFenYe?pageNum=${requestScope.page.last}&search=${requestScope.search}">尾页</a>
        </div>
    </div>
</div>
